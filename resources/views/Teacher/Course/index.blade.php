...
<div id="app">
  ...
  <div class="ml-7 mt-5">
    <div class="text-center py-1 bg-gray-700 text-gray-100 shadow-xl w-32 rounded-md">
      <a href="{{ route('teacher-courses.create',Auth::user()->id) }}">Create</a>
    </div>
  </div>
          ...
          <tr>
            ...
            <td class="actions-cell">
              <div class="buttons right nowrap">
                <a  href="{{ route('teacher-courses.edit',[$course->id,$course->id]) }}" class="button small green --jb-modal" type="button">
                  <span class="icon">
                ...
                <a  href="{{ route('teacher-chapters',$course->id) }}" class="button small green --jb-modal" type="button">
                  <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
