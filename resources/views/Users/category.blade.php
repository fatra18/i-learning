...
<body class="bg-gray-900">
    <div class="container-fluid">
        ...
        <div>
            <div class="text-center text-3xl text-gray-100 font-bold mt-8">
                Page-Category
            </div>
            <div class="flex">
                <div class="border-2 border-gray-100 w-1/4 bg-gray-700 my-10 ml-5 h-full">
                ...
                <div class="border w-11/12 flex flex-wrap ml-5 items-center mr-10 mt-10 h-full mb-10">
