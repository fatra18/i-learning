    ...
    <div class="tab w-full h-full  border-t">
      ...
      <div class="tab-content overflow-auto border-l-2 bg-gray-100 border-indigo-500 leading-normal">
        ...
        <div class="flex mb-10 space-x-10">
          <a  href="{{ route('teacher-video.edit',[$item->id,$data->id]) }}" class="button small green --jb-modal ml-5" type="button">
            <span class="icon">
          ...
          <form action="{{ route('teacher-video.delete',$item->id) }}"method="POST">
            @csrf
