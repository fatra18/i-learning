...
<div id="app">
  ...
  <div class="ml-7 mt-5">
    <div class="text-center py-1 bg-gray-700 text-gray-100 shadow-xl w-32 rounded-md">
      <a href="{{ route('teacher-chapter.create', $course_id) }}">Create</a>
    </div>
  </div>
        ...
        <table>
         ...
         <tr>
          ...
          <td data-label="Action">
            ...
            <div class="buttons ">
              <a  href="{{ route('teacher-chapter.edit',$item->id) }}" class="button small green --jb-modal" type="button">
                <span class="icon">
              ...
              <a  href="{{ route('teacher-chapter.detail',[$item->id,$item->id]) }}" class="button small green --jb-modal" type="button">
                <span class="icon">
              ...
              <a  href="{{ route('teacher-video.create',$item->id) }}" class="button small blue --jb-modal" type="button">
                <span class="icon">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <form action="{{ route('teacher-chapter.delete',$item->id) }}"method="POST">
                @csrf
