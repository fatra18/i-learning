  {{-- Footer --}}
<div class="mt-28 bg-blue-900 shadow-xl">
    <div class="flex justify-between  py-10 items-center w-full">
        ...
        <div class="text-4xl text-gray-100 flex ml-96 ">
            <div class="ml-3  h-16 w-16 rounded-full flex justify-center items-center text-md shadow-xl">
                <i class="fa fa-instagram " ></i>
            </div>
            <div class="ml-3  h-16 w-16 rounded-full flex justify-center items-center text-md">
...
<script>
    ...
    document.onscroll = function() {
        if (document.documentElement.scrollTop > 0) {
            navbar.classList.add('shadow-lg','bg-blue-900','top-3','text-gray-100')
        } else {
            navbar.classList.remove('shadow-lg','bg-blue-900','text-gray-100')
        }
    }
</script>
