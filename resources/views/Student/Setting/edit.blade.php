...
<body>
    ...
    <h1 class="text-2xl font-bold ml-10">Student Setting</h1>
    @if ($errors->any())
    ...
    <div class="ml-10 mt-10">
        <div class="mt-96 sm:mt-0 ">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                ...
                <form  method="POST" action="{{ route('Student-setting-update',$students->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input 
                                type="text" 
                                name="phone_number"
                                value="{{ old('name',$students->phone_number)}}"   
                                id="first-name" 
                                autocomplete="given-name" 
                                class="mt-1 bg-gray-100 focus:border-gray-100 block shadow-sm sm:text-sm border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-100 py-1 w-11/12 px-3"
                                >
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input 
                                type="text" 
                                name="achievement"
                                value="{{ old('name',$students->achievement)}}"     
                                autocomplete="email" 
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input 
                                ...
                                name="email-address" 
                                id="email-address"
                                value="{{ old('name',$students->password)}}"      
                                autocomplete="email" 
                                class="mt-1 bg-gray-100  focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-100 py-1 px-3"
                                >
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input 
                                type="text" 
                                name="description" 
                                value="{{ old('name',$students->description)}}"      
                                autocomplete="email" 
                                class="mt-1 bg-gray-100  focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-100 py-1 px-3"
                                >
                        </div>
