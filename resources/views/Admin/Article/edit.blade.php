...
<section class="section main-section">
  <form class="form form-horizontal" method="POST" action="{{ route('articles.update',$article->id) }}" enctype="multipart/form-data">
   @csrf
   @method('PUT')
     <div>
       <div>
       ...
       <div class="mt-10">
         <input type="file" class="form-control" id="basicInput"name="image_file" type="file"  value="{{ old('image',$article->image) }}"
         placeholder="Image">      
       </div>
     </div>
