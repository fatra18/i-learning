     ...
     <div class="relative mt-20" data-aos="fade-up">
         <div class="flex bg-blue-900 py-10 justify-evenly border-2 border-gray-400 rounded-2xl">
             <div class="flex items-center">
                 ...
                 <div class=" ml-5">
                     <h1 class="text-2xl text-gray-100">Design</h1>
                     <p class="text-gray-100">111111111</p>
                 </div>
             </div>
             <div class="flex items-center">
                 <img src="{{ asset('dist/img/category-programming.svg') }}" alt="" class="w-44">
                 <div class=" ml-5">
                     <h1 class="text-2xl text-gray-100">Programming</h1>
                     <p class="text-gray-100">111111111</p>
                 </div>
             </div>
             <div class="flex items-center">
                 ...
                 <div class=" ml-5">
                     <h1 class="text-2xl text-gray-100">VideoGrapich</h1>
                     <p class="text-gray-100">111111111</p>
                 </div>
             </div>
         </div>
         ...
         <div class="flex gap-14 flex-wrap justify-center">
             <div class="bg-blue-900 shadow-xl w-2/5 flex rounded-r-xl rounded-l-lg ">
               <a href="{{ route('course-details') }}">
                <div class="ml-5">
                    <h1 class="pt-10 pb-5 font-bold text-gray-100 ">Web Development</h1>
                    <p class=" w-11/12 leading-6 pb-5 text-gray-100 ">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                       Provident, 
                    </p>
                ...
                <img src="{{ asset('/dist/img/courses-web.svg') }}" alt="" class="w-64 h-68 bg-cover bg-center rounded-r-xl mr-4">
             </div>
             <div class="bg-blue-900 shadow-xl w-2/5 flex rounded-r-xl rounded-l-lg">
               <a href="{{ route('course-details') }}">
                <div class="ml-5">
                    <h1 class="pt-10 pb-5 font-bold text-gray-100">Web Mobile</h1>
                    <p class=" w-11/12 leading-6 pb-5 text-gray-100 ">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                       Provident, 
                    </p>
                    <div class="flex pb-10">
                ...
                <img src="{{ asset('/dist/img/courses-mobile.svg') }}" alt="" class="w-64 h-68 bg-cover bg-center rounded-r-xl">
             </div>
             <div class="bg-blue-900 shadow-xl w-2/5 flex rounded-r-xl rounded-l-lg">
               <a href="{{ route('course-details') }}">
                <div class="ml-5">
                    <h1 class="pt-10 pb-5 font-bold text-gray-100">Logo Design</h1>
                    <p class=" w-11/12 leading-6 pb-5 text-gray-100 ">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                       Provident, 
                    </p>
                    <div class="flex pb-10">
                ...
                <img src="{{ asset('/dist/img/courses-logo.svg') }}" alt="" class="w-64 h-68 bg-cover bg-center rounded-r-xl mr-5">
             </div>
             <div class="bg-blue-900 shadow-xl w-2/5 flex rounded-r-xl rounded-l-lg">
               <a href="{{ route('course-details') }}">
                <div class="ml-5">
                    <h1 class="pt-10 pb-5 font-bold text-gray-100">Logo Icon</h1>
                    <p class=" w-11/12 leading-6 pb-5 text-gray-100 ">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                       Provident, 
                    </p>
                    <div class="flex pb-10">
                ...
                <img src="{{ asset('/dist/img/courses-icon.svg') }}" alt="" class="w-64 h-68 bg-cover bg-center rounded-r-xl mr-3">
             </div>            
             <div class="bg-blue-900 shadow-xl w-2/5 flex rounded-r-xl rounded-l-lg">
               <a href="{{ route('course-details') }}">
                <div class="ml-5">
                    <h1 class="pt-10 pb-5 font-bold text-gray-100">Editing Photo</h1>
                    <p class=" w-11/12 leading-6 pb-5 text-gray-100 ">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                       Provident, 
                    </p>
                    <div class="flex pb-10">
                ...
                <img src="{{ asset('/dist/img/courses-edit.svg') }}" alt="" class="w-64 h-68 bg-cover bg-center rounded-r-xl mr-5">
             </div>
             <div class="bg-blue-900 shadow-xl w-2/5 flex rounded-r-xl rounded-l-lg">
               <a href="{{ route('course-details') }}">
                <div class="ml-5">
                    <h1 class="pt-10 pb-5 font-bold text-gray-100">Editing Video</h1>
                    <p class=" w-11/12 leading-6 pb-5 text-gray-100 ">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                       Provident, 
                    </p>
                    <div class="flex pb-10">
                ...
                <img src="{{ asset('/dist/img/courses-video.svg') }}" alt="" class="w-64 h-68 bg-cover bg-center rounded-r-xl mr-3">
             </div>            
         </div>
     </div>
     ...
     <div class="flex mt-20 gap-20 ml-10" data-aos="fade-down">
         <div class="">
             ...
             <div class="bg-blue-900 shadow-xl w-11/12 rounded-b-2xl">
                <h1 class="pt-7 pl-5 font-bold text-gray-100">Name</h1>
                <small class="pt-7 pl-5 text-gray-100 ">Student</small>
                <p class=" px-5 py-5 w-full text-gray-100">Lorem ipsum dolor sit amet
         ...
         <div class="relative flex  ml-20 mt-20">  
            <a href="{{ route('teacher-details') }}">
                ...
                <div class="bg-blue-900 shadow-xl relative bottom-40 w-4/5 rounded-t-xl flex  flex-col  mr-8 ">
                    <p class="pt-7 pb-4 text-xl text-gray-100 font-bold ml-7">Kak Dia</p>
                    <p class="pb-5  w-full  text-gray-100 ml-7">Fullstack Developer</p>
                    <div class="border-b-2 border-gray-100 border-dotted"></div>
                    <p class="ml-7 mt-5 text-gray-100">1st Place hacking goggle</p>
